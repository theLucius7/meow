...
- Buffered MacFlare snapshots are delayed upstream. The card shows the activity without a delay label.
...
These screenshots show a local preview of the sidebar layout. The displayed app and music depend on the API snapshot at the time of viewing.
